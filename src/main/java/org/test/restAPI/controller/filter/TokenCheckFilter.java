package org.test.restAPI.controller.filter;
...
import org.test.restAPI.controller.filter.exception.AccessTokenException;
...
public class TokenCheckFilter extends OncePerRequestFilter {
    ...
    private Map<String, Object> validateAccessToken(HttpServletRequest request) throws AccessTokenException, ExpiredJwtException {
        ...
        if(headerStr == null){
            throw new AccessTokenException("Can not find AcessToken");
        }
